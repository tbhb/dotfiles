...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/tony/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/tony/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/tony/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/Users/tony/.tmux/plugins//tmux-continuum"
# }
